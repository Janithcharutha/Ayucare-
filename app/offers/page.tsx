...
export default function OffersPage() {
  ...
  const offerProducts: OfferProduct[] = [
    {
      id: 1,
      name: "Skin Glowing & Wellness Kit for Normal to Dry Skin",
      slug: "skin-glowing-wellness-kit",
      category: "bundle-kits",
      categoryName: "BUNDLE KITS",
      image: "/placeholder.svg?height=400&width=400&text=Skin+Glowing+Kit",
      originalPrice: 8250,
      discountedPrice: 6950,
      description: "Try our total care trio with natural ingredients and contains NO harsh chemicals/bleaching agents.",
      contents: ["Saffron Day Cream (with SPF 15)", "Kasthuri Kaha Night Cream", "Kasthuri Kaha Face Wash"],
    },
    {
      id: 2,
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
        {paginatedProducts.map((product) => (
          <div key={product.id} className="group relative">
            ...
            {/* Product image */}
            <div className="relative mb-4 overflow-hidden rounded-lg bg-[#f5f0e8]">
